...
def test_project_decision_campaign():
    ...
    assert out["campaign"] == 'Rolling-Horizon Fab Campaign'
    assert out["campaign_identity"] == 'ranking entropy + tail-risk recovery frontier'
    assert 'ranking_entropy_bits' in out
